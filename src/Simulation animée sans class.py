...
def doubler(pos,i,vdv,vdr1,vdv1,vdv0,vdr0,nf):
    ...
    if pos[i,1]+1<nf and pos[vdv,2]<pos[i,3] and ecart < 8*pos[i,2] and vdv!=i and pos[i,4]==0:
        ...
        if ecart0dr > pos[vdr0,2]*T or vdr0==i: #distance correspondant à 2 sec a la vitesse 
            if (ecart0dv > pos[vdv0,2]*T and pos[vdv0,2]+1>=pos[i,2]) or vdv0==i:
                res=-1
                pos[i,4]=15/dt
    return res
